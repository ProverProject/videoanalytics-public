...
#ifndef PROVER_BOUNDSCHECKER_H
#define PROVER_BOUNDSCHECKER_H
...
/**
 * Checks that we are closer to source or target swype points (and a line between them) then to other swype points
 *
